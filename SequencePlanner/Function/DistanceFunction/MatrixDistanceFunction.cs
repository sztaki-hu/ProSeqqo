...
{
    public class MatrixDistanceFunction : IDistanceFunction
    {
        public string FunctionName { get { return "MatrixDistance"; } }
        //Header of the cost matrix with the ResourceIDs
        public List<int> IDList { get; set; }
        public List<List<double>> CostMatrix { get; }


        public MatrixDistanceFunction(List<List<double>> costMatrix, List<int> resourceIDList)
        {
